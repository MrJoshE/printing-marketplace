...
var ListingsCols = []string{
	...
	"description", "price_min_unit", "currency", "categories", "license",
	"client_id", "trace_id", "thumbnail_path",
...
// FIX: Added 'updated_at' which exists in Schema.
var ListingFileCols = []string{
	"id", "listing_id", "file_path", "file_type", "file_size",
	"metadata", "status", "error_message", "created_at", "updated_at", "deleted_at",
}
